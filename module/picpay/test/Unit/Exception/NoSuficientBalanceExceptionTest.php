...
class NoSuficientBalanceExceptionTest extends AbstractHttpControllerTestCase
{
    private $class;
    ...
    public function setUp(): void
    {
        ...
        $this->class = $this->getApplication()->getServiceManager()->get('Transaction\Exception\NoSuficientBalanceException');
    }
